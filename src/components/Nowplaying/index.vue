...
export default {
    ...
    mounted () {
        ...
        axios({
        url:`https://m.maizuo.com/gateway?cityId=${this.cityid}&pageNum=1&pageSize=10&type=1&k=8165506`,
            headers:{
    ...
    methods: {
        ...
        loadMore(){
            ...
            axios({
                url: `https://m.maizuo.com/gateway?cityId=${this.cityid}&pageNum=${this.iNow}&pageSize=10&type=1&k=8165506`,
                headers: {
                'X-Client-Info': '{"a":"3000","ch":"1002","v":"5.0.4","e":"16132234251904032016760833","bc":"341100"}',
                'X-Host': 'mall.film-ticket.film.list'
                }
